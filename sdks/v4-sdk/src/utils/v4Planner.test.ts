...
import { CurrencyAmount, Ether, Percent, TradeType, Token, WETH9 } from '@dyadex-finance/sdk-core'
import { encodeSqrtRatioX96, nearestUsableTick, TickMath } from '@dyadex-finance/v3-sdk'
...
describe('RouterPlanner', () => {
  ...
  describe('addTrade', () => {
    ...
    it('completes a v4 exactIn swap with empty maxHopSlippage when not provided (V2.1)', async () => {
      ...
      planner.addTrade(trade, undefined, undefined, URVersion.V2_1_1)
